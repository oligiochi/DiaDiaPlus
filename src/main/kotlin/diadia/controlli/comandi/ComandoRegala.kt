...
class ComandoRegala: AbstractComando() {
    override fun esegui(partita: Partita) = partita.getPlayer().getBorsa().getAttrezzo(getParametro())?.let { partita.getStanzaCorrente().getPersonaggio()!!.riceviRegalo(it,partita) }.toString()
